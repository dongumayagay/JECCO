  ...
  <div class="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
    ...
    <div class="overflow-y-auto overflow-x-hidden flex-grow">
      <div class="flex flex-col py-4 space-y-1">
          ...
          <a href="/admin/collectorsprof" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            <span class="inline-flex justify-center items-center ml-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
