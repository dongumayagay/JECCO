...
<section class="flex flex-col w-full h-screen p-6 ml-8 overflow-y-auto bg-gray-200 ">
    ...
    <div class="flex items-center pl-4 shadow-md sm:rounded-lg h-10 bg-white gap-16">
        
        <button class=" btn btn-ghost btn-xs sm:btn-2xs md:btn-xs lg:btn-sm hover:bg-gray-300">
...
<div class="overflow-x-auto relative shadow-md sm:rounded-lg h-full bg-white mt-4">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <div class="pl-3">
                        ...
                        <div class="font-normal text-gray-500">neil.sims@jecco.com</div>
                    </div>  
                </th>
                <td class="py-4 px-6">
                    Admin staff
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <div class="pl-3">
                        ...
                        <div class="font-normal text-gray-500">bonnie@jecco.com</div>
                    </div>
                </th>
                <td class="py-4 px-6">
                    Collector
            ...
            <tr class="bg-white bordr-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td class="p-4 w-4">
                    <div class="flex items-center">
                        <input id="checkbox-table-search-2" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox-table-search-2" class="sr-only">checkbox</label>
                ...
                <th scope="row" class="flex items-center py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <div class="pl-3">
                        ...
                        <div class="font-normal text-gray-500">jese@jecco.com</div>
                    </div>
                </th>
                <td class="py-4 px-6">
                    Collector
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <div class="pl-3">
                        ...
                        <div class="font-normal text-gray-500">thomes@jecco.com</div>
                    </div>
                </th>
                <td class="py-4 px-6">
                    Admin staff
            ...
            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <div class="pl-3">
                        ...
                        <div class="font-normal text-gray-500">leslie@jecco.com</div>
                    </div>
                </th>
                <td class="py-4 px-6">
                    Staff
